...
@Component({
  ...
  templateUrl: './add-write-off-stock.component.html',
  styleUrls: ['./add-write-off-stock.component.scss']
})
export class AddWriteOffStockComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private myProdServ: ProductService, private formBuilder: FormBuilder, private dataService: DataService,
    ...
    //PopUp Construtor
    public dialogRef: MatDialogRef<AddWriteOffStockComponent>,
