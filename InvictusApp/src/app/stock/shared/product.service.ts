...
export class ProductService {
  ...
  allProductDD() {
    return this.http.get('https://localhost:44395/api/Product/allProductDD');
  }

  WriteOff() {
    return this.http.get('https://localhost:44395/api/Product/WriteOff');
  }


  CreateWriteOff(myWriteOff) {
    return this.http.post('https://localhost:44395/api/Product/CreateWriteOff', myWriteOff);
  }
  ...
  getWriteOffByID(id: number) {
    return this.http.get('https://localhost:44395/api/writeoff/writeoffbyID?id=' + id);
  }
